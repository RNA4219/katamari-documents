...
| Day8 HUB | `third_party/Day8/workflow-cookbook/HUB.codex.md` | Day8 オペレーション全体を俯瞰する観測ハブ。 |
| Day8 Guardrails | `third_party/Day8/workflow-cookbook/GUARDRAILS.md` | Day8 が定義する統制基準・安全策。 |
| Day8 Blueprint | `third_party/Day8/workflow-cookbook/BLUEPRINT.md` | Guardrails を適用した運用ブループリント。 |
...
- Day8 系資料の推奨読書順: `third_party/Day8/workflow-cookbook/HUB.codex.md` → `third_party/Day8/workflow-cookbook/GUARDRAILS.md` → `third_party/Day8/workflow-cookbook/BLUEPRINT.md`（観測 → 統制 → 実行設計の流れで理解が深まる）。
